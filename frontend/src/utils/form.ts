...
export const handleTextInputChange = <T extends Record<string, any>>(
  formData: T,
  setFormData: (data: T) => void,
  field: keyof T
) => (e: Event) => {
...
export const handleTextAreaChange = <T extends Record<string, any>>(
  formData: T,
  setFormData: (data: T) => void,
  field: keyof T
) => (e: Event) => {
...
export const handleCheckboxChange = <T extends Record<string, any>>(
  formData: T,
  setFormData: (data: T) => void,
  field: keyof T
) => (e: Event) => {
