		...
		<div className="h-100 d-flex flex-column">
							...
							<div className="col-md-4 mb-3">
								...
								<input
									...
									onChange={e =>
										setFormData({
											...formData,
											age: (e.target as HTMLInputElement).value,
										})
									}
									placeholder="Age"
									min="0"
						...
						<div className="mb-3">
							...
							<textarea
								...
								onChange={e =>
									setFormData({
										...formData,
										specialAbilities: (e.target as HTMLTextAreaElement).value,
									})
								}
							...
							<div className="col-md-6 mb-3">
								...
								<input
									...
									onChange={e =>
										setFormData({
											...formData,
											favoriteFood: (e.target as HTMLInputElement).value,
										})
									}
							...
							<div className="col-md-6 mb-3">
								...
								<input
									...
									onChange={e =>
										setFormData({
											...formData,
											favoriteToy: (e.target as HTMLInputElement).value,
										})
									}
						...
						<div className="mb-3">
							...
							<textarea
								...
								onChange={e =>
									setFormData({
										...formData,
										rescueStory: (e.target as HTMLTextAreaElement).value,
									})
								}
						...
						<div className="mb-3">
							...
							<textarea
								...
								onChange={e =>
									setFormData({
										...formData,
										stats: (e.target as HTMLTextAreaElement).value,
									})
								}
							...
							<div className="col-md-6 mb-3">
								...
								<input
									...
									onChange={e =>
										setFormData({
											...formData,
											adoptedDate: (e.target as HTMLInputElement).value,
										})
									}
								/>
							</div>
			...
			<div className="flex-grow-1 overflow-auto">
				{pets.map(pet => (
					<div
						key={pet.id}
						className={`card mb-2 ${!pet.isActive ? "opacity-75 bg-light" : ""}`}
					>
						<div className="card-body">
							<div className="d-flex gap-3">
								...
								<div className="flex-grow-1">
									<div className="d-flex align-items-center gap-2 mb-1">
										...
										<span
											className={`badge ${pet.isActive ? "bg-success" : "bg-secondary"}`}
										>
									...
									{pet.personality && (
										<p className="small mb-0">Personality: {pet.personality}</p>
									)}
								</div>
								<div className="d-flex gap-2">
									<button
